...
bin/kern_a2.elf: bin/kern.o bin/userTasks.o bin/queue.o bin/nameServer.o bin/string.o 
	$(LD) $(LDFLAGS) -o bin/kern_a2.elf bin/string.o bin/kern.o bin/queue.o bin/nameServer.o bin/userTasks.o -lbwio -lgcc
	cp bin/kern_a2.elf /u/cs452/tftp/ARM/mdbaker/kern_a2.elf
