...
bin/kern_a2.elf: bin/kern.o bin/userTasks.o bin/queue.o bin/nameServer.o bin/string.o bin/clock.o
	$(LD) $(LDFLAGS) -o bin/kern_a2.elf bin/string.o bin/kern.o bin/queue.o bin/nameServer.o bin/userTasks.o bin/clock.o -lbwio -lgcc
