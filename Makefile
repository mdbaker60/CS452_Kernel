...
bin/kern_a4.elf: recursive $(wildcard bin/*.o)
	$(LD) $(LDFLAGS) -o bin/kern_a4.elf bin/*.o -lbwio -lgcc
	cp bin/kern_a4.elf /u/cs452/tftp/ARM/djgroot/kern_a4.elf
