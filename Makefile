...
bin/a1.s: kern/a1.c kern/mem/mem.c kern/include/a1.h kern/include/task.h kern/include/mem.h
	$(XCC) -S $(CFLAGS) kern/mem/mem.c kern/a1.c
	mv a1.s bin/a1.s
	mv mem.s bin/mem.s
...
bin/a1.o: bin/a1.s kern/syscall.s kern/genAss.s
	...
	$(AS) $(ASFLAGS) -o bin/mem.o bin/mem.s

bin/userTasks.o: bin/userTasks.s
	$(AS) $(ASFLAGS) -o bin/userTasks.o bin/userTasks.s

bin/a1.elf: bin/a1.o bin/userTasks.o
	$(LD) $(LDFLAGS) -o bin/a1.elf bin/a1.o bin/mem.o bin/userTasks.o -lbwio -lgcc
	cp bin/a1.elf /u/cs452/tftp/ARM/mdbaker/a1.elf
