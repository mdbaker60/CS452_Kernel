...
bin/kern_p1.elf: recursive $(wildcard bin/*.o)
	$(LD) $(LDFLAGS) -o bin/kern_p1.elf bin/*.o -lbwio -lgcc
	cp bin/kern_p1.elf /u/cs452/tftp/ARM/djgroot/kern_p1.elf
