...
#define ICU1_BASE	0x800B0000
#define ICU2_BASE	0x800C0000

#define STAT_OFFSET	0x00000000
#define RAW_OFFSET	0x00000008
#define SEL_OFFSET	0x0000000C
#define ENBL_OFFSET	0x00000010
#define ENCL_OFFSET	0x00000014
	#define CLK3_MASK	0x00080000
	#define UART1RX_MASK	0x00800000
